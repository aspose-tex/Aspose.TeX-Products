---
title: .NET API-k és alkalmazások a TeX dokumentumok feldolgozásához 
weight: 20
url: /hu/net/ 
description: C# ASP.NET VB.NET könyvtár a TeX dokumentumok szedéséhez. A megoldás számos kimeneti fájlformátumot támogat, például XPS, PDF, SVG, PNG, JPEG, TIFF, BMP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API-k a TeX fájlok szedéséhez" h2="TeX fájlok gépelése .NET alapú alkalmazásokban." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az Aspose.TeX áttekintése .NET API-hoz." >}}
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     A kimeneti dokumentumok beszerzése különböző formátumokban, például XPS, PDF, PNG, JPEG, TIFF, BMP, SVG
    </li>
    <li>
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Az Aspose.TeX for .NET támogatja az összes főbb platformot, beleértve." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="TeX Files Typesetting API-k" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.TeX for .NET a következő [fájlformátumokat] támogatja(https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Speciális .NET TeX fájlszedési API-funkciók
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Az Aspose.TeX for .NET könnyen be tudja szedni a TeX fájlokat<a href="/tex/net/conversion/">szerezzen dokumentumokat</a> különböző formátumokban.
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API referenciák" href="https://apireference.aspose.com/tex/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért Aspose.TeX for .NET?" tabId="success-stories" >}}
