---
title: API de procesamiento e integración C++ TeX - Aspose 
weight: 50
url: /es/cpp/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Biblioteca de manipulación C++ TeX" h2="Componga y convierta archivos TeX y LaTeX dentro de aplicaciones basadas en C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-cpp.svg" pfName="Aspose.TeX" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/tex/cpp" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una descripción general de Aspose.TeX para la API de C++." >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de procesamiento C++ TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="La biblioteca es totalmente compatible con las aplicaciones C++ desarrolladas en la plataforma Windows y Linux que tienen [Requisitos del sistema](https://docs.aspose.com/tex/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulación de PUB" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.TeX para C++ admite lo siguiente [formatos de archivo](https://docs.aspose.com/tex/cpp/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API TeX de C++" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX para C++ puede componer fácilmente archivos TeX para <a href="/tex/cpp/conversion/">obtener documentos</a> en diferentes formatos.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/tex/cpp" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-tex/Aspose.TeX-for-C" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://apireference.aspose.com/tex/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.TeX para C++?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.TeX" description="Aspose.TeX ofrece API de administración de TeX individuales para otros entornos de desarrollo populares, como se indica a continuación:" >}}
