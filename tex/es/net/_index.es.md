---
title: API y aplicaciones .NET para procesar documentos TeX 
weight: 20
url: /es/net/ 
description: Biblioteca C# ASP.NET VB.NET para componer documentos TeX. La solución admite muchos formatos de archivo de salida como XPS, PDF, SVG, PNG, JPEG, TIFF, BMP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API .NET para componer archivos TeX" h2="Componga archivos TeX dentro de aplicaciones basadas en .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una descripción general de Aspose.TeX para la API de .NET." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Obtenga documentos de salida en diferentes formatos como XPS, PDF, PNG, JPEG, TIFF, BMP, SVG
    </li>
    <li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de composición tipográfica de archivos .NET TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.TeX para .NET es compatible con todas las plataformas principales, incluidas." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de composición tipográfica de archivos TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.TeX para .NET es compatible con los siguientes [formatos de archivo](https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API TeX de .NET" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Advanced API de composición tipográfica de archivos .NET TeX Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX para .NET puede componer fácilmente archivos TeX para<a href="/tex/net/conversion/">obtener documentos</a> en diferentes formatos.
    </p>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/tex/net/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.TeX para .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.TeX" description="Aspose.TeX ofrece API de procesamiento de TeX individuales para otros entornos de desarrollo populares, como se indica a continuación:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/tex/es/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-java.svg" sdkName="Java" >}}
