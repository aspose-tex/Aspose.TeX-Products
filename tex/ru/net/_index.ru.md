---
title: .NET API и приложения для обработки документов TeX 
weight: 20
url: /ru/net/ 
description: Библиотека C# ASP.NET VB.NET для верстки документов TeX. Решение поддерживает множество форматов выходных файлов, таких как XPS, PDF, SVG, PNG, JPEG, TIFF, BMP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API для верстки файлов TeX" h2="Набор файлов TeX в приложениях на базе .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="С одного взгляда" description="Обзор Aspose.TeX для .NET API." >}}
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Получайте выходные документы в различных форматах, таких как XPS, PDF, PNG, JPEG, TIFF, BMP, SVG.
    </li>
    <li>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.TeX для .NET поддерживает все основные платформы, в том числе." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API для набора файлов TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.TeX для .NET поддерживает следующие [форматы файлов](https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Расширенные возможности API набора текста файлов .NET TeX
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX для .NET может легко набирать файлы TeX для<a href="/tex/net/conversion/">получить документы</a> в разных форматах.
    </p>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://apireference.aspose.com/tex/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.TeX для .NET?" tabId="success-stories" >}}
