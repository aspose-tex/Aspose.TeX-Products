---
title: Convert TEX to JPEG with .NET 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TEX to JPEG via C#" h2="Convert TeX files to XPS, PDF & Image formats like BMP on Windows, macOS & Linux">}}
...
4. Run TeX to JPEG conversion using [TeXJob](https://apireference.aspose.com/tex/net/aspose.tex/texjob) method
