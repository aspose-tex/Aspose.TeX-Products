...
title: TEX إلى BMP Converdion API | C++
description: وظائف تحويل TEX إلى BMP. ادمج مكتبة C++ المحلية هذه في مشروعك أو استخدم التطبيقات عبر الأنظمة الأساسية لتحويل TeX إلى BMP.
keywords: tex إلى bmp api cpp و دمج tex2bmp C++
...
---
h1: TEX إلى BMP
h2: تحويل TEX إلى BMP عبر API Solution لـ C++.
---

{{<section overview>}}
---
title: "كيفية تحويل TEX إلى BMP باستخدام C++"
p1: "Aspose.TeX for TEX to BMP Converter يحول ملف TEX إلى صورة BMP باستخدام أي لغة تدعمها C++."
...
h3: "يوضح نموذج الشفرة هذا تحويل TEX إلى BMP C++"
item1: "يسهل Aspose.TeX على المطورين تحويل ملفات TEX إلى BMP في بضعة أسطر من التعليمات البرمجية."
...
item5: "قم بتشغيل تحويل TeX إلى BMP باستخدام أسلوب [*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job)"
---
