...
---
h1: LaTeX إلى XPS
h2: قم بتحويل LaTeX إلى XPS عبر حل API لـ C++.
---

{{<section overview>}}
---
title: "كيفية تحويل LaTeX إلى XPS باستخدام C++"
p1: "يقوم Aspose.TeX for LaTeX to XPS Converter بتحويل ملف LaTeX إلى صورة XPS باستخدام أي لغة مدعومة بواسطة C++."
...
h3: "يوضح نموذج التعليمات البرمجية هذا LATEX لتحويل XPS C++"
...
item5: "قم بتشغيل تحويل LaTeX إلى XPS باستخدام أسلوب [*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job)"
---
