...
---
h1: TEX إلى XPS
h2: تحويل TEX إلى XPS عبر API Solution لـ C++.
---

{{<section overview>}}
---
title: "كيفية تحويل TEX إلى XPS باستخدام C++"
p1: "Aspose.TeX for TEX to XPS Converter يحول ملف TeX إلى صورة XPS باستخدام أي لغة مدعومة بواسطة C++."
...
h3: "يوضح نموذج التعليمات البرمجية هذا تحويل TEX إلى XPS C++"
...
item4: "ابدأ خيارات الحفظ بتنسيق XPS باستخدام [*XpsSaveOptions*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.presentation.image.xps_save_options)"
item5: "قم بتشغيل تحويل TeX إلى XPS باستخدام أسلوب [*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job)"
---
