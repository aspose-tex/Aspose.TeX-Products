...
title: LaTeX إلى PDF واجهة برمجة تطبيقات تحويل | .NET
description: وظائف تحويل LaTeX إلى PDF. ادمج مكتبة .NET المحلية هذه في مشروعك أو استخدم التطبيقات عبر الأنظمة الأساسية لتحويل LaTeX إلى PDF.
keywords: 'اللاتكس إلى pdf api net و دمج latex2pdf c #'
...
---
h1: LaTeX إلى PDF
h2: "قم بتحويل LaTeX إلى PDF عبر حل API لـ C # .NET."
---

{{<section overview>}}
---
title: "كيفية تحويل LaTeX إلى PDF باستخدام C # .NET"
p1: "Aspose.TeX for LaTeX to PDF Converter يحول ملف LaTeX إلى صورة PDF باستخدام أي لغة يدعمها C #."
...
h3: "يوضح نموذج التعليمات البرمجية هذا تحويل LATEX إلى PDF .NET"
...
item5: "قم بتشغيل تحويل LaTeX إلى PDF باستخدام طريقة [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
