---
title: APIs e aplicativos .NET para processar documentos TeX 
weight: 20
url: /pt/net/ 
description: Biblioteca C# ASP.NET VB.NET para escrever documentos TeX. A solução suporta muitos formatos de arquivo de saída como XPS, PDF, SVG, PNG, JPEG, TIFF, BMP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="APIs .NET para compor arquivos TeX" h2="Componha arquivos TeX dentro de aplicativos baseados em .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="Num relance" description="Uma visão geral do Aspose.TeX para .NET API." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Obtenha documentos de saída em diferentes formatos como XPS, PDF, PNG, JPEG, TIFF, BMP, SVG
    </li>
    <li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de composição de arquivos .NET TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independência da plataforma" description="O Aspose.TeX para .NET suporta todas as principais plataformas, incluindo." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="APIs de composição de arquivos TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="O Aspose.TeX para .NET suporta os seguintes [formatos de arquivo](https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Advanced API de composição de arquivos .NET TeX Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     O Aspose.TeX para .NET pode facilmente compor arquivos TeX para<a href="/tex/net/conversion/">obter documentos</a> em diferentes formatos.
    </p>
