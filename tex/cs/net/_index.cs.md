---
title: .NET API a aplikace pro zpracování dokumentů TeX 
weight: 20
url: /cs/net/ 
description: C# ASP.NET Knihovna VB.NET pro sazbu TeXových dokumentů. Řešení podporuje mnoho formátů výstupních souborů jako XPS, PDF, SVG, PNG, JPEG, TIFF, BMP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API pro sazbu souborů TeX" h2="Vysázet soubory TeXu v aplikacích založených na .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled Aspose.TeX for .NET API." >}}
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Získejte výstupní dokumenty v různých formátech, jako je XPS, PDF, PNG, JPEG, TIFF, BMP, SVG
    </li>
    <li>
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.TeX pro .NET podporuje všechny hlavní platformy včetně." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Rozhraní API pro sázení souborů TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.TeX pro .NET podporuje následující [formáty souborů](https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX for .NET může snadno vysázet soubory TeX<a href="/tex/net/conversion/">získat dokumenty</a> v různých formátech.
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/tex/net/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.TeX pro .NET?" tabId="success-stories" >}}
