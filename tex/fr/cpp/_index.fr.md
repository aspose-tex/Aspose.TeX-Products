---
title: API d'intégration et de traitement C++ TeX - Aspose 
weight: 50
url: /fr/cpp/ 
description: Bibliothèque C++ TeX pour traiter les fichiers TeX dans les applications C++. Il offre des fonctionnalités de composition ainsi que la conversion de TeX en PDF, SVG, XPS et autres formats.
keywords: conversion tex api cpp, convertisseur tex c++ intégré
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bibliothèque de manipulation C++ TeX" h2="Composez et convertissez des fichiers TeX et LaTeX dans des applications basées sur C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-cpp.svg" pfName="Aspose.TeX" subTitlepfName="for C++" downloadUrl="https://releases.aspose.com/tex/cpp" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu de Aspose.TeX pour l'API C++." >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de traitement C++ TeX" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="La bibliothèque prend entièrement en charge les applications C++ développées sur la plate-forme Windows et Linux ayant [Configuration requise](https://docs.aspose.com/tex/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulation PUB" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.TeX pour C++ prend en charge les éléments suivants [formats de fichiers](https://docs.aspose.com/tex/cpp/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API TeX C++" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX pour C++ peut facilement composer des fichiers TeX pour <a href="/tex/cpp/conversion/">obtenir des documents</a> sous différents formats.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-tex/Aspose.TeX-for-C" >}}
{{< blocks/products/pf/slr-element name="Références API" href="https://reference.aspose.com/tex/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.TeX pour C++ ?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.TeX" description="Aspose.TeX propose des API de gestion TeX individuelles pour d'autres environnements de développement populaires, comme indiqué ci-dessous :" >}}
