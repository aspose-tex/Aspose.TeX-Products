...
title: API การแปลง TEX เป็น XPS | C++
description: ฟังก์ชันการแปลง TeX เป็น XPS รวมไลบรารี C++ ภายในองค์กรนี้เข้ากับโครงการของคุณหรือใช้แอปพลิเคชันข้ามแพลตฟอร์มเพื่อแปลง TeX เป็น XPS
keywords: tex เป็น xps api cpp, tex2xps รวม c++
...
---
h1: TEX เป็น XPS
h2: แปลง TEX เป็น XPS ผ่าน API Solution สำหรับ C++
---

{{<section overview>}}
---
title: "วิธีแปลง TEX เป็น XPS โดยใช้ C++"
p1: "Aspose.TeX สำหรับตัวแปลง TEX เป็น XPS แปลงไฟล์ TeX เป็นอิมเมจ XPS โดยใช้ภาษาใด ๆ ที่ C ++ รองรับ"
...
{{<section feature1>}}
---
title: "ขั้นตอนในการแปลง TEX เป็น XPS โดยใช้ C++"
h3: "ตัวอย่างโค้ดนี้อธิบาย TEX เป็น XPS C++ Conversion"
...
item5: "เรียกใช้การแปลง TeX เป็น XPS โดยใช้วิธี [*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job)"
---
