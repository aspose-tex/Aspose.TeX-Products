...
---
h1: TeX เป็น PDF
h2: แปลง TeX เป็น PDF ผ่าน API Solution สำหรับ Java
---

{{<section overview>}}
---
title: "วิธีแปลง TeX เป็น PDF โดยใช้ Java"
p1: "Aspose.TeX สำหรับ TeX เป็น PDF converter แปลงไฟล์ TeX เป็นรูปภาพ PDF โดยใช้ภาษาใดก็ได้ที่ Java รองรับ"
...
{{<section feature1>}}
---
title: "ขั้นตอนในการแปลง TeX เป็น PDF บน Java"
h3: "ตัวอย่างโค้ดนี้อธิบาย TEX เป็น PDF Java Conversion"
...
item4: "เริ่มต้นตัวเลือกสำหรับการบันทึกในรูปแบบ PDF โดยใช้ [*PdfSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/PdfSaveOptions)"
item5: "เรียกใช้การแปลง TeX เป็น PDF โดยใช้วิธี [*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob)"
---
