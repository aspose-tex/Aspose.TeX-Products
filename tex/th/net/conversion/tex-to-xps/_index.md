...
title: TeX เป็น XPS Converdion API | .NET
description: ฟังก์ชันการแปลง TeX เป็น XPS รวมไลบรารี .NET ภายในองค์กรนี้เข้ากับโครงการของคุณหรือใช้แอปพลิเคชันข้ามแพลตฟอร์มเพื่อแปลง TeX เป็น XPS
keywords: 'tex ถึง xps api net, tex2xps รวม c #'
...
---
h1: TeX เป็น XPS
h2: "แปลง TeX เป็น XPS ผ่าน API Solution สำหรับ C# .NET"
---

{{<section overview>}}
---
title: "วิธีแปลง TeX เป็น XPS โดยใช้ C# .NET"
...
h3: "ตัวอย่างโค้ดนี้อธิบาย TeX เป็น XPS .NET Conversion"
...
item4: "เริ่มต้นตัวเลือกสำหรับการบันทึกในรูปแบบ XPS โดยใช้ [*XpsSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/xpssaveoptions/)"
item5: "เรียกใช้การแปลง TeX เป็น XPS โดยใช้วิธี [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)"
---
