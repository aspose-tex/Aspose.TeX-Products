...
---
h1: LaTeX เป็น XPS
h2: "แปลง LaTeX เป็น XPS ผ่าน API Solution สำหรับ C# .NET"
---

{{<section overview>}}
---
title: "วิธีแปลง LaTeX เป็น XPS โดยใช้ C# .NET"
p1: "Aspose.TeX สำหรับตัวแปลง LaTeX เป็น XPS แปลงไฟล์ LaTeX เป็นอิมเมจ XPS โดยใช้ภาษาใดๆ ที่ C # รองรับ"
...
h3: "ตัวอย่างโค้ดนี้อธิบาย LATEX เป็น XPS .NET Conversion"
...
item5: "เรียกใช้การแปลง LaTeX เป็น XPS โดยใช้วิธี [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)"
---
