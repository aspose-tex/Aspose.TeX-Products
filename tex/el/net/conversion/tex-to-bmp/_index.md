...
title: API μετατροπής TeX σε BMP | .NET
description: Λειτουργία μετατροπής TeX σε BMP. Ενσωματώστε αυτήν την εσωτερική βιβλιοθήκη .NET στο έργο σας ή χρησιμοποιήστε εφαρμογές πολλαπλών πλατφορμών για να μετατρέψετε το TeX σε BMP.
...
---
h1: TeX σε BMP
h2: "Μετατροπή TeX σε BMP μέσω API Solution για C# .NET."
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε TeX σε BMP χρησιμοποιώντας C# .NET"
p1: "Ο μετατροπέας Aspose.TeX for TeX σε BMP μετατρέπει το αρχείο TeX σε εικόνα BMP με τη χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από C#."
...
h3: "Αυτό το δείγμα κώδικα εξηγεί τη μετατροπή TeX σε BMP .NET"
...
item5: "Εκτελέστε τη μετατροπή TeX σε BMP χρησιμοποιώντας τη μέθοδο [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
