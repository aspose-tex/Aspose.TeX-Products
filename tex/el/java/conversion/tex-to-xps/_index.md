...
title: API μετατροπής TeX σε XPS | Java
description: Λειτουργία μετατροπής TeX σε XPS. Ενσωματώστε αυτήν τη βιβλιοθήκη Java on-premise στο έργο σας ή χρησιμοποιήστε εφαρμογές πολλαπλών πλατφορμών για να μετατρέψετε το TeX σε XPS.
keywords: tex σε xps api java, tex2xps ενσωμάτωση
...
---
h1: TeX σε XPS
h2: Μετατροπή TeX σε XPS μέσω Λύσης API για Java
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε το TeX σε XPS χρησιμοποιώντας Java"
p1: "Ο μετατροπέας Aspose.TeX for TeX σε XPS μετατρέπει το αρχείο TeX σε εικόνα XPS με τη χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από την Java."
...
{{<section feature1>}}
---
title: "Βήματα για τη μετατροπή TeX σε XPS σε Java"
h3: "Αυτό το δείγμα κώδικα εξηγεί τη μετατροπή Java σε TEX σε XPS"
...
item5: "Εκτελέστε τη μετατροπή TeX σε XPS χρησιμοποιώντας τη μέθοδο [*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob)."
---
