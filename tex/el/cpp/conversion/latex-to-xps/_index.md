...
title: LaTeX σε XPS Converdion API | C++
description: Λειτουργία μετατροπής LaTeX σε XPS. Ενσωματώστε αυτήν την εσωτερική βιβλιοθήκη C++ στο έργο σας ή χρησιμοποιήστε εφαρμογές πολλαπλών πλατφορμών για να μετατρέψετε το LaTeX σε XPS.
keywords: latex σε xps api cpp, latex2xps ενσωμάτωση c++
...
---
h1: LaTeX σε XPS
h2: Μετατροπή LaTeX σε XPS μέσω API Solution για C++.
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε LaTeX σε XPS χρησιμοποιώντας C++"
p1: "Ο μετατροπέας Aspose.TeX για LaTeX σε XPS μετατρέπει το αρχείο LaTeX σε εικόνα XPS με τη χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από τη C++."
...
h3: "Αυτό το δείγμα κώδικα εξηγεί τη μετατροπή LATEX σε XPS C++"
...
item5: "Εκτελέστε τη μετατροπή LaTeX σε XPS χρησιμοποιώντας τη μέθοδο [*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job)."
---
