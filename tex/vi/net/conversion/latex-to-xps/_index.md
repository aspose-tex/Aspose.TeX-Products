...
title: API chuyển đổi từ LaTeX sang XPS | .NET
description: Chức năng chuyển đổi LaTeX sang XPS. Tích hợp thư viện .NET tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi LaTeX sang XPS.
keywords: 'latex sang xps api net, latex2xps tích hợp c #'
...
---
h1: LaTeX sang XPS
h2: "Chuyển đổi LaTeX sang XPS thông qua Giải pháp API cho C # .NET."
---

{{<section overview>}}
---
title: "Cách chuyển đổi LaTeX sang XPS bằng C # .NET"
p1: "Bộ chuyển đổi Aspose.TeX for LaTeX sang XPS chuyển đổi tệp LaTeX thành hình ảnh XPS bằng cách sử dụng bất kỳ ngôn ngữ nào được C # hỗ trợ."
...
h3: "Mẫu mã này giải thích Chuyển đổi LATEX sang XPS .NET"
...
item4: "Khởi tạo các tùy chọn để lưu ở định dạng XPS bằng [*XpsSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/xpssaveoptions/)."
item5: "Chạy chuyển đổi LaTeX sang XPS bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
