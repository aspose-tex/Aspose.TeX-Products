...
title: API chuyển đổi từ LaTeX sang JPEG | .NET
description: Chức năng chuyển đổi LaTeX sang JPEG. Tích hợp thư viện .NET tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi LaTeX sang JPEG.
keywords: 'latex sang jpeg api net, latex2jpeg tích hợp c #'
...
---
h1: LaTeX sang JPEG
h2: "Chuyển đổi LaTeX sang JPEG thông qua Giải pháp API cho C # .NET."
---

{{<section overview>}}
---
title: "Cách chuyển đổi LaTeX sang JPEG bằng C # .NET"
p1: "Bộ chuyển đổi Aspose.TeX cho LaTeX sang JPEG chuyển đổi tệp LaTeX thành hình ảnh JPEG bằng cách sử dụng bất kỳ ngôn ngữ nào được C # hỗ trợ."
...
{{<section feature1>}}
---
title: "Các bước chuyển đổi LATEX sang JPEG bằng C #"
h3: "Mẫu mã này giải thích Chuyển đổi LATEX sang JPEG .NET"
...
item4: "Khởi tạo các tùy chọn để lưu ở định dạng JPEG bằng [*JpegSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/jpegsaveoptions/)."
item5: "Chạy chuyển đổi LaTeX sang JPEG bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
