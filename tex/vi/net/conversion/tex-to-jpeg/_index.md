...
title: API chuyển đổi TeX sang JPEG | .NET
description: Chức năng chuyển đổi TeX sang JPEG. Tích hợp thư viện .NET tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi TeX sang JPEG.
keywords: 'tex sang jpeg api net, tex2jpeg tích hợp c #'
...
---
h1: TeX sang JPEG
h2: "Chuyển đổi TeX sang JPEG thông qua Giải pháp API cho C # .NET."
---

{{<section overview>}}
---
title: "Cách chuyển đổi TeX sang JPEG bằng C # .NET"
p1: "Bộ chuyển đổi Aspose.TeX for TeX sang JPEG chuyển đổi tệp TeX sang hình ảnh JPEG bằng cách sử dụng bất kỳ ngôn ngữ nào được C # hỗ trợ."
...
h3: "Mẫu mã này giải thích chuyển đổi TeX sang JPEG .NET"
...
item5: "Chạy chuyển đổi TeX sang JPEG bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
