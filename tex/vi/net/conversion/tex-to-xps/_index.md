...
title: API chuyển đổi TeX sang XPS | .NET
description: Chức năng chuyển đổi TeX sang XPS. Tích hợp thư viện .NET tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi TeX sang XPS.
keywords: 'tex sang xps api net, tex2xps tích hợp c #'
...
---
h1: TeX sang XPS
h2: "Chuyển đổi TeX sang XPS thông qua Giải pháp API cho C # .NET."
---

{{<section overview>}}
---
title: "Cách chuyển đổi TeX sang XPS bằng C # .NET"
...
h3: "Mẫu mã này giải thích chuyển đổi TeX sang XPS .NET"
item1: "Aspose.TeX giúp các nhà phát triển dễ dàng chuyển đổi các tệp TeX sang XPS chỉ trong một vài dòng mã."
...
item5: "Chạy chuyển đổi TeX sang XPS bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/)."
---
