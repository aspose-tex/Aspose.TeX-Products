...
title: API chuyển đổi từ LaTeX sang XPS | Java
description: Chức năng chuyển đổi LaTeX sang XPS. Tích hợp thư viện Java tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi LaTeX sang XPS.
keywords: latex sang xps api java, tích hợp latex2xps
...
---
h1: LaTeX sang XPS
h2: Chuyển đổi LaTeX sang XPS thông qua Giải pháp API cho Java
---

{{<section overview>}}
---
title: "Cách chuyển đổi LaTeX sang XPS bằng Java"
p1: "Bộ chuyển đổi Aspose.TeX cho LaTeX sang XPS chuyển đổi tệp LaTeX thành hình ảnh XPS bằng cách sử dụng bất kỳ ngôn ngữ nào được Java hỗ trợ."
...
{{<section feature1>}}
---
title: "Các bước chuyển đổi LATEX sang XPS trên Java"
h3: "Mẫu mã này giải thích Chuyển đổi Java LATEX sang XPS"
...
item4: "Khởi tạo các tùy chọn để lưu ở định dạng XPS bằng [*XpsSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/XpsSaveOptions)."
item5: "Chạy chuyển đổi LaTeX sang XPS bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob)."
---
