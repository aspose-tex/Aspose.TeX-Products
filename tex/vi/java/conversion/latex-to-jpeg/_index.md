...
title: API chuyển đổi từ LaTeX sang JPEG | Java
description: Chức năng chuyển đổi LaTeX sang JPEG. Tích hợp thư viện Java tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi LaTeX sang JPEG.
keywords: latex sang jpeg api java, tích hợp latex2jpeg
...
---
h1: LaTeX sang JPEG
h2: Chuyển đổi LaTeX sang JPEG thông qua Giải pháp API cho Java
---

{{<section overview>}}
---
title: "Cách chuyển đổi LaTeX sang JPEG bằng Java"
p1: "Bộ chuyển đổi Aspose.TeX cho LaTeX sang JPEG chuyển đổi tệp LaTeX thành hình ảnh JPEG bằng cách sử dụng bất kỳ ngôn ngữ nào được Java hỗ trợ."
...
p3: "Để chuyển đổi LaTeX sang JPEG:"
...
{{<section feature1>}}
---
title: "Các bước chuyển đổi LATEX sang JPEG trên Java"
h3: "Mẫu mã này giải thích Chuyển đổi Java LATEX sang JPEG"
item1: "Aspose.TeX giúp các nhà phát triển dễ dàng chuyển đổi các tệp LATEX sang JPEG chỉ trong một vài dòng mã."
...
item4: "Khởi tạo các tùy chọn để lưu ở định dạng JPEG bằng [*JpegSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/JpegSaveOptions)."
item5: "Chạy chuyển đổi LaTeX sang JPEG bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob)."
---
