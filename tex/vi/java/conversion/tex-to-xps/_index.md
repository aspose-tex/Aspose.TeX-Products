...
title: API chuyển đổi TeX sang XPS | Java
description: Chức năng chuyển đổi TeX sang XPS. Tích hợp thư viện Java tại chỗ này vào dự án của bạn hoặc sử dụng các ứng dụng đa nền tảng để chuyển đổi TeX sang XPS.
keywords: tex sang xps api java, tích hợp tex2xps
...
---
h1: TeX sang XPS
h2: Chuyển đổi TeX sang XPS thông qua Giải pháp API cho Java
---

{{<section overview>}}
---
title: "Cách chuyển đổi TeX sang XPS bằng Java"
p1: "Công cụ chuyển đổi Aspose.TeX for TeX sang XPS chuyển đổi tệp TeX thành hình ảnh XPS bằng cách sử dụng bất kỳ ngôn ngữ nào được Java hỗ trợ."
...
{{<section feature1>}}
---
title: "Các bước chuyển đổi TeX sang XPS trên Java"
h3: "Mẫu mã này giải thích Chuyển đổi Java TEX sang XPS"
...
item5: "Chạy chuyển đổi TeX sang XPS bằng phương pháp [*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob)."
---
