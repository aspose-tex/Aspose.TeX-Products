---
title: Giải pháp API TeX cho Java, .NET và C++
weight: 10
url: /vi/family
description: TeX Native APIs cho .NET, Java và C++. Đây là một giải pháp dễ sử dụng và tích hợp để sắp chữ, xử lý và chuyển đổi các tệp TeX và LaTeX trên mọi nền tảng.
---
...
{{< blocks/products/pf/product pfName="Aspose.TeX for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg" productLink="/tex/vi/net/" >}}
Nhắm mục tiêu Windows Forms, ASP.NET hoặc bất kỳ loại ứng dụng nào dựa trên .NET Framework 2.0 trở lên.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.TeX for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-java.svg" productLink="/tex/vi/java/" >}}
Các API Java gốc cho máy tính để bàn, web hoặc bất kỳ loại ứng dụng nào dựa trên Java SE hoặc EE.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.TeX for" title="C++" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-cpp.svg" productLink="/tex/vi/cpp/" >}}
Tích hợp chức năng sắp xếp và chuyển đổi tệp TeX vào các ứng dụng C++.
{{< /blocks/products/pf/product >}}
