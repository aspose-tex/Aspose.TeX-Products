...
title: LaTeX에서 JPEG로의 변환 API | Java
description: LaTeX에서 JPEG로의 변환 기능. 이 사내 Java 라이브러리를 프로젝트에 통합하거나 크로스 플랫폼 애플리케이션을 사용하여 LaTeX를 JPEG로 변환하십시오.
keywords: jpeg API 자바에 라텍스, latex2jpeg 통합
...
---
h1: 라텍스를 JPEG로
h2: Java용 API 솔루션을 통해 LaTeX를 JPEG로 변환
---

{{<section overview>}}
---
title: "Java를 사용하여 LaTeX를 JPEG로 변환하는 방법"
p1: "Aspose.TeX for LaTeX to JPEG 변환기는 Java에서 지원하는 모든 언어를 사용하여 LaTeX 파일을 JPEG 이미지로 변환합니다."
...
{{<section feature1>}}
---
title: "Java에서 LATEX에서 JPEG로 변환하는 단계"
h3: "이 코드 샘플은 LATEX에서 JPEG로의 Java 변환에 대해 설명합니다."
...
item4: "[*JpegSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/JpegSaveOptions)를 사용하여 JPEG 형식으로 저장하는 옵션을 초기화합니다."
item5: "[*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob) 메서드를 사용하여 LaTeX에서 JPEG로 변환을 실행합니다."
---
