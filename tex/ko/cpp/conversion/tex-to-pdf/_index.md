...
title: TEX에서 PDF로 변환 API | C++
description: TeX에서 PDF로의 변환 기능. 이 온프레미스 C++ 라이브러리를 프로젝트에 통합하거나 크로스 플랫폼 애플리케이션을 사용하여 TeX를 PDF로 변환합니다.
keywords: tex에서 pdf api cpp로, tex2pdf에서 C++ 통합
...
---
h1: TEX에서 PDF로
h2: C++용 API 솔루션을 통해 TEX를 PDF로 변환합니다.
---

{{<section overview>}}
---
title: "C++를 사용하여 TEX을 PDF로 변환하는 방법"
p1: "Aspose.TeX for TEX to PDF 변환기는 C++에서 지원하는 모든 언어를 사용하여 TeX 파일을 PDF 이미지로 변환합니다."
...
{{<section feature1>}}
---
title: "C++를 사용하여 TEX를 PDF로 변환하는 단계"
h3: "이 코드 샘플은 TEX에서 PDF C++로의 변환을 설명합니다."
item1: "Aspose.TeX를 사용하면 개발자가 몇 줄의 코드로 TEX 파일을 PDF로 쉽게 변환할 수 있습니다."
...
item4: "[*PdfSaveOptions*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.presentation.image.pdf_save_options)를 사용하여 PDF 형식으로 저장하는 옵션을 초기화합니다."
item5: "[*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job) 메서드를 사용하여 TeX에서 PDF로 변환을 실행합니다."
---
