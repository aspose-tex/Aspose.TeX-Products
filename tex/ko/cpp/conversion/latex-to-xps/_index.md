...
title: LaTeX에서 XPS로 변환 API | C++
description: LaTeX에서 XPS로의 변환 기능. 이 온프레미스 C++ 라이브러리를 프로젝트에 통합하거나 크로스 플랫폼 애플리케이션을 사용하여 LaTeX를 XPS로 변환하십시오.
keywords: 라텍스에서 xps api cpp로, latex2xps에서 C++ 통합
...
---
h1: 라텍스에서 XPS로
h2: C++용 API 솔루션을 통해 LaTeX를 XPS로 변환합니다.
---

{{<section overview>}}
---
title: "C++를 사용하여 LaTeX를 XPS로 변환하는 방법"
...
{{<section feature1>}}
---
title: "C++를 사용하여 LATEX을 XPS로 변환하는 단계"
h3: "이 코드 샘플은 LATEX에서 XPS C++로의 변환을 설명합니다."
...
item4: "[*XpsSaveOptions*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.presentation.image.xps_save_options)를 사용하여 XPS 형식으로 저장하는 옵션을 초기화합니다."
item5: "[*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job) 메서드를 사용하여 LaTeX에서 XPS로 변환을 실행합니다."
---
