...
title: LaTeX에서 XPS로의 변환 API | .NET
description: LaTeX에서 XPS로의 변환 기능. 이 온프레미스 .NET 라이브러리를 프로젝트에 통합하거나 크로스 플랫폼 애플리케이션을 사용하여 LaTeX를 XPS로 변환하십시오.
keywords: latex to xps api net, latex2xps는 C#을 통합합니다.
...
---
h1: 라텍스에서 XPS로
h2: "C# .NET용 API 솔루션을 통해 LaTeX를 XPS로 변환합니다."
---

{{<section overview>}}
---
title: "C# .NET을 사용하여 LaTeX를 XPS로 변환하는 방법"
p1: "Aspose.TeX for LaTeX to XPS 변환기는 C#에서 지원하는 모든 언어를 사용하여 LaTeX 파일을 XPS 이미지로 변환합니다."
p2: "여기에서 볼 수 있는 API를 사용하여 자체 플랫폼 간 애플리케이션을 만들거나 .NET 프로젝트에 통합할 수 있습니다."
p3: "LaTeX를 XPS로 변환하려면:"
...
{{<section feature1>}}
---
title: "C#을 사용하여 LATEX을 XPS로 변환하는 단계"
h3: "이 코드 샘플은 LATEX에서 XPS .NET으로의 변환을 설명합니다."
item1: "Aspose.TeX를 사용하면 개발자가 몇 줄의 코드로 LATEX 파일을 XPS로 쉽게 변환할 수 있습니다."
...
item4: "[*XpsSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/xpssaveoptions/)를 사용하여 XPS 형식으로 저장하는 옵션을 초기화합니다."
item5: "[*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/) 메서드를 사용하여 LaTeX에서 XPS로 변환을 실행합니다."
---
