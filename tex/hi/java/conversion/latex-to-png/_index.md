...
title: लाTEX से PNG कन्वर्जन एपीआई | Java
description: "LATEX से PNG रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस जावा लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या लाTEX को PNG में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: लेTEX टू PNG एपीआई जावा, लेTEX 2 PNG एकीकृत
...
---
h1: लेTEX से PNG
h2: "जावा के लिए एपीआई समाधान के माध्यम से लाTEX को PNG में बदलें"
---

{{<section overview>}}
---
title: "जावा का उपयोग करके लाTEX को PNG में कैसे बदलें"
p1: "लाTEX से PNG कनवर्टर के लिए Aspose.TeX जावा द्वारा समर्थित किसी भी भाषा के उपयोग के साथ लाTEX फ़ाइल को PNG छवि में बदल देता है।"
...
{{<section feature1>}}
---
title: "जावा पर लेTEX से PNG रूपांतरण के लिए कदम"
h3: "यह कोड नमूना लेTEX को PNG जावा रूपांतरण के बारे में बताता है"
...
item4: "[*PngSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/PngSaveOptions) का उपयोग करके PNG फॉर्मेट में सेव करने के विकल्पों को इनिशियलाइज़ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob) विधि का उपयोग करके LaTeX से PNG रूपांतरण चलाएँ।"
---
