...
title: "टीएक्स से XPS कन्वर्जन एपीआई | Java"
description: "टीएक्स से XPS रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस जावा लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या टीएक्स को XPS में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: TEX टू XPS एपीआई जावा, TEX2XPS एकीकृत
...
---
h1: टीएक्स से XPS
h2: "जावा के लिए एपीआई समाधान के माध्यम से टीएक्स को XPS में "
---

{{<section overview>}}
---
title: "जावा का उपयोग करके TeX को XPS में कैसे बदलें"
p1: "TeX से XPS कनवर्टर के लिए Aspose.TeX जावा द्वारा समर्थित किसी भी भाषा के उपयोग के साथ TeX फ़ाइल को XPS छवि में बदल देता है।"
...
p3: "TeX को XPS में बदलने के लिए:"
...
{{<section feature1>}}
---
title: "जावा पर टीएक्स से XPS रूपांतरण के चरण"
h3: "यह कोड नमूना TEX को XPS जावा रूपांतरण के बारे में बताता है"
item1: "Aspose.TeX डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में TEX फ़ाइलों को XPS में बदलना आसान बनाता है।"
...
item4: "[*XpsSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/XpsSaveOptions) का उपयोग करके XPS प्रारूप में सहेजने के विकल्पों को प्रारंभ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob) विधि का उपयोग करके TeX से XPS रूपांतरण चलाएं।"
---
