...
title: "टीएक्स से JPEG कन्वर्जन एपीआई | Java"
description: "टीएक्स से JPEG रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस जावा लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या टीएक्स को JPEG में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: TEX टू JPEG एपीआई JPEG, TEX2JPEG इंटीग्रेट
...
---
h1: टीएक्स से JPEG
h2: "जावा के लिए एपीआई समाधान के माध्यम से टीएक्स को JPEG में "
---

{{<section overview>}}
---
title: "जावा का उपयोग करके TeX को JPEG में कैसे बदलें"
p1: "Aspose.TeX के लिए TeX से JPEG कनवर्टर जावा द्वारा समर्थित किसी भी भाषा के उपयोग के साथ TeX फ़ाइल को JPEG छवि में बदल देता है।"
...
{{<section feature1>}}
---
title: "जावा पर टीएक्स से JPEG रूपांतरण के लिए कदम"
h3: "यह कोड नमूना TEX को JPEG जावा रूपांतरण के बारे में बताता है"
...
item4: "[*JpegSaveOptions*](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/JpegSaveOptions) का उपयोग करके JPEG फॉर्मेट में सेव करने के विकल्पों को इनिशियलाइज़ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob) विधि का उपयोग करके TeX से JPEG रूपांतरण चलाएँ।"
---
