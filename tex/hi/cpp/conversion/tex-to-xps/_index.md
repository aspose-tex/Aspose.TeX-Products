...
title: "TEX टू XPS कन्वर्जन एपीआई | C++"
description: "टीएक्स से XPS रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस C++ लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या TeX को XPS में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: "TEX टू XPS एपीआई सीपीपी, TEX2XPS इंटीग्रेटेड C++"
...
{{<section overview>}}
---
title: "C++ का उपयोग करके TEX को XPS में कैसे बदलें?"
p1: "Aspose.TeX के लिए TEX से XPS कनवर्टर, TeX फ़ाइल को XPS छवि में C++ द्वारा समर्थित किसी भी भाषा का उपयोग करके रूपांतरित करता है।"
...
{{<section feature1>}}
---
title: "C++ का उपयोग करके TEX को XPS में बदलने के चरण"
h3: "यह कोड नमूना TEX को XPS C++ रूपांतरण के बारे में बताता है"
...
item5: "[*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job) विधि का उपयोग करके TeX से XPS रूपांतरण चलाएं।"
---
