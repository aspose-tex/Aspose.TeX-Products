...
title: "TEX टू PDF कन्वर्जन एपीआई | C++"
description: "टीएक्स से PDF रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस C++ लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या TeX को PDF में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: "TEX टू PDF़ एपीआई सीपीपी, TEX2PDF इंटीग्रेटेड C++"
...
{{<section overview>}}
---
title: "C++ का उपयोग करके TEX को PDF में कैसे बदलें?"
p1: "TEX से PDF कनवर्टर के लिए Aspose.TeX C++ द्वारा समर्थित किसी भी भाषा के उपयोग के साथ TeX फ़ाइल को PDF छवि में बदल देता है।"
...
p3: "TEX को PDF में बदलने के लिए:"
...
{{<section feature1>}}
---
title: "C++ का उपयोग करके TEX को PDF में बदलने के चरण"
h3: "यह कोड नमूना TEX को PDF C++ रूपांतरण के बारे में बताता है"
...
item4: "[*PdfSaveOptions*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.presentation.image.pdf_save_options) का उपयोग करके PDF फॉर्मेट में सेव करने के विकल्पों को इनिशियलाइज़ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job) विधि का उपयोग करके TeX से PDF रूपांतरण चलाएँ।"
---
