...
{{<section overview>}}
---
title: "C++ का उपयोग करके LaTeX को BMP में कैसे बदलें?"
p1: "Aspose.TeX लाTEX से BMP कनवर्टर के लिए C++ द्वारा समर्थित किसी भी भाषा के उपयोग के साथ लाTEX फ़ाइल को BMP छवि में बदल देता है।"
...
p4: "C++ API के लिए Aspose.TeX का उपयोग करें जो एक सुविधा संपन्न, शक्तिशाली और उपयोग में आसान दस्तावेज़ हेरफेर और C++ प्लेटफॉर्म के लिए रूपांतरण API है।"
...
{{<section feature1>}}
---
title: "C++ का उपयोग करके LATEX को BMP में बदलने के चरण"
h3: "यह कोड नमूना लेTEX को BMP C++ रूपांतरण के बारे में बताता है"
...
item3: "[*OutputWorkingDirectory*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_options#aa4f4ea6dab7db5ba1b40800495f16f63) का उपयोग करके आउटपुट के लिए फ़ाइल सिस्टम कार्यशील निर्देशिका निर्दिष्ट करें।"
...
item5: "[*TeXJob()*](https://reference.aspose.com/tex/cpp/class/aspose.te_x.te_x_job) विधि का उपयोग करके LaTeX से BMP रूपांतरण चलाएँ।"
---
