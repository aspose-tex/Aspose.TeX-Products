...
title: "लाटेक्स से PDF कन्वर्जन एपीआई | .NET"
description: "LaTeX से PDF रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस .NET लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या LaTeX को PDF में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: "लेटेक्स से PDF एपीआई नेट, लेटेक्स 2 PDF C# को एकीकृत करता है"
...
---
h1: लेटेक्स से PDF
h2: "C# .NET के लिए एपीआई समाधान के माध्यम से लाटेक्स को PDF में कनवर्ट करें।"
---

{{<section overview>}}
---
title: "C# .NET का उपयोग करके LaTeX को PDF में कैसे बदलें?"
p1: "LaTeX से PDF कनवर्टर के लिए Aspose.TeX C# द्वारा समर्थित किसी भी भाषा के उपयोग के साथ LaTeX फ़ाइल को PDF छवि में बदल देता है।"
...
p3: "लाटेक्स को PDF में बदलने के लिए:"
...
{{<section feature1>}}
---
title: "C# का उपयोग करके लेटेक्स को PDF में बदलने के लिए कदम"
h3: "यह कोड नमूना लेटेक्स को PDF .NET रूपांतरण के बारे में बताता है"
...
item4: "[*PdfSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/pdfsaveoptions/) का उपयोग करके PDF फॉर्मेट में सेव करने के विकल्पों को इनिशियलाइज़ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/) विधि का उपयोग करके LaTeX से PDF रूपांतरण चलाएँ।"
---
