...
title: लाटेक्स से BMP कन्वर्जन एपीआई | .NET
description: "लाटेक्स से BMP रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस .NET लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या LaTeX को BMP में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: "लेटेक्स से BMP एपीआई नेट, लेटेक्स 2 BMP C# को एकीकृत करता है"
...
---
h1: लाटेक्स से BMP
h2: "C# .NET के लिए एपीआई समाधान के माध्यम से लाटेक्स को BMP में कनवर्ट करें।"
---

{{<section overview>}}
---
title: "C# .NET का उपयोग करके LaTeX को BMP में कैसे बदलें?"
p1: "Aspose.TeX लाटेक्स से BMP कनवर्टर के लिए C# द्वारा समर्थित किसी भी भाषा के उपयोग के साथ लाटेक्स फ़ाइल को BMP छवि में बदल देता है।"
...
{{<section feature1>}}
---
title: "C#का उपयोग करके लेटेक्स को BMP में बदलने के लिए कदम"
h3: "यह कोड नमूना लेटेक्स को BMP .NET रूपांतरण के बारे में बताता है"
...
item4: "[*BmpSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/bmpsaveoptions/) का उपयोग करके BMP प्रारूप में बचत के विकल्पों को प्रारंभ करें।"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/) विधि का उपयोग करके LaTeX से BMP रूपांतरण चलाएँ।"
---
