...
title: "टीएक्स टू PDF कन्वर्जन एपीआई | .NET"
description: "टीएक्स से PDF रूपांतरण कार्यक्षमता। इस ऑन-प्रिमाइसेस .NET लाइब्रेरी को अपने प्रोजेक्ट में एकीकृत करें या टीएक्स को PDF में बदलने के लिए क्रॉस-प्लेटफ़ॉर्म एप्लिकेशन का उपयोग करें।"
keywords: "PDF एपीआई नेट के लिए टेक्स, टेक्स 2 PDF C# को एकीकृत करता है"
...
---
h1: टीएक्स से PDF
h2: "C# .NET के लिए एपीआई समाधान के माध्यम से टीएक्स को PDF में कनवर्ट करें।"
---

{{<section overview>}}
---
title: "C# .NET का उपयोग करके TeX को PDF में कैसे बदलें?"
p1: "Aspose.TeX के लिए TeX से PDF कन्वर्टर, C# द्वारा समर्थित किसी भी भाषा के उपयोग के साथ TeX फ़ाइल को PDF छवि में बदल देता है।"
...
{{<section feature1>}}
---
title: "C# का उपयोग कर टीएक्स को PDF में कनवर्ट करने के लिए कदम"
h3: "यह कोड नमूना TeX को PDF .NET रूपांतरण के बारे में बताता है"
...
item5: "[*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/) विधि का उपयोग करके TeX से PDF रूपांतरण चलाएँ।"
---
