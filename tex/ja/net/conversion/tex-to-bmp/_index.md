...
title: TeX から BMP への変換 API | .NET
description: TeX から BMP への変換機能。このオンプレミス .NET ライブラリをプロジェクトに統合するか、クロスプラットフォーム アプリケーションを使用して TeX を BMP に変換します。
keywords: texからbmp api netへ、tex2bmpはc#を統合
...
---
h1: TeX から BMP
h2: "C# .NET の API ソリューションを介して TeX を BMP に変換します。"
---

{{<section overview>}}
---
title: "C# .NET を使用して TeX を BMP に変換する方法"
p1: "Aspose.TeX for TeX to BMP コンバーターは、C# でサポートされている任意の言語を使用して、TeX ファイルを BMP イメージに変換します。"
...
{{<section feature1>}}
---
title: "C# を使用して TeX を BMP に変換する手順"
h3: "このコード サンプルでは、​​TeX から BMP .NET への変換について説明します。"
...
item4: "[*BmpSaveOptions*](https://reference.aspose.com/tex/net/aspose.tex.presentation.image/bmpsaveoptions/) を使用して、BMP 形式で保存するためのオプションを初期化します。"
item5: "[*TeXJob()*](https://reference.aspose.com/tex/net/aspose.tex/texjob/) メソッドを使用して TeX から BMP への変換を実行します。"
---
