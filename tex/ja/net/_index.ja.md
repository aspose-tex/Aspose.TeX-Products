---
title: TeXドキュメントを処理するための.NETAPIとアプリ 
weight: 20
url: /ja/net/ 
description: TeXドキュメントをタイプセットするためのC＃ASP.NETVB.NETライブラリ。このソリューションは、XPS、PDF、SVG、PNG、JPEG、TIFF、BMPなどの多くの出力ファイル形式をサポートしています。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="TeXファイルをタイプセットするための.NETAPI" h2=".NETベースのアプリケーション内でTeXファイルを植字します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.TeX for.NETAPIの概要。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     XPS、PDF、PNG、JPEG、TIFF、BMP、SVGなどのさまざまな形式で出力ドキュメントを取得します
    </li>
    <li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NETTeXファイル植字API" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.TeX for .NETは、を含むすべての主要なプラットフォームをサポートしています。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="TeXファイル植字API" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.TeX for .NETは、次の[ファイル形式]をサポートしています。(https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX for .NETは、TeXファイルを簡単にタイプセットできます。<a href="/tex/net/conversion/">ドキュメントを取得する</a> さまざまな形式で。
    </p>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://apireference.aspose.com/tex/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.TeX for.NETを選ぶ理由" tabId="success-stories" >}}
