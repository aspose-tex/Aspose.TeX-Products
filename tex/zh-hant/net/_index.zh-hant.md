---
title: .NET API 和應用程序來處理 TeX 文檔 
weight: 20
url: /zh-hant/net/ 
description: 用於排版 TeX 文檔的 C# ASP.NET VB.NET 庫。該解決方案支持多種輸出文件格式，如 XPS、PDF、SVG、PNG、JPEG、TIFF、BMP。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於排版 TeX 文件的 .NET API" h2="在基於 .NET 的應用程序中排版 TeX 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tex/headers/aspose_tex-for-net.svg" pfName="Aspose.TeX for .NET" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/tex/net" tryOnlineUrl="https://products.aspose.app/tex/family" >}}
...
<p>
Aspose.TeX for .NET 是一個靈活且易於使用的庫，用於排版 TeX 和 LaTeX 文件。 API 支持多種輸出格式，如 XPS、PDF、PNG、JPEG、TIFF、SVG、BMP。這意味著通過這個庫的功能，您可以將 TeX 和 LaTeX 文件轉換為任何輸出格式。使用該解決方案，如果您想創建和/或排版一組統一設計的文檔，您可以創建自定義的 TeX 格式。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.TeX for .NET API 概述。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     獲取不同格式的輸出文檔，如 XPS、PDF、PNG、JPEG、TIFF、BMP、SVG
    </li>
    <li>
     將輸出文檔寫入流
    </li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET TeX 文件排版 API" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.TeX for .NET 支持所有主要平台，包括。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="TeX 文件排版 API" src="https://www.aspose.cloud/templates/aspose/img/products/tex/aspose_tex-for-net.svg"/>
  <header>
   Aspose.TeX
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.TeX for .NET 支持以下 [文件格式](https://docs.aspose.com/tex/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Advanced .NET TeX 文件排版 API Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.TeX for .NET 可以輕鬆地將 TeX 文件排版為<a href="/tex/net/conversion/">獲取文件</a> 以不同的格式。
    </p>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/tex/net" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-tex/Aspose.TeX-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/tex/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼為 .NET 使用 Aspose.TeX？" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.TeX" description="Aspose.TeX 為其他流行的開發環境提供了單獨的 TeX 處理 API，如下所示：" >}}
