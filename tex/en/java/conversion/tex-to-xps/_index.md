...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java Api Solution to convert TeX to XPS." h2=" Integrate TeX to XPS conversion functionality of On-premise Java library into your own project.">}}
...
3. Initialize the options for saving in XPS format using [XpsSaveOptions](https://reference.aspose.com/tex/java/com.aspose.tex.rendering/XpsSaveOptions)
4. Run TeX to XPS conversion using [TeXJob](https://reference.aspose.com/tex/java/com.aspose.tex/TeXJob) method
