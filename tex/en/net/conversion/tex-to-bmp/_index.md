...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET Api Solution to convert TeX to BMP." h2=" Integrate TeX to BMP conversion functionality of On-premise .NET library into your own project.">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TEX to BMP Conversion on .NET" %}}
...
3. Initialize the options for saving in BMP format using [BmpSaveOptions](https://reference.aspose.com/tex/net/aspose.tex.presentation.image)
4. Run TeX to BMP conversion using [TeXJob](https://reference.aspose.com/tex/net/aspose.tex/texjob) method
